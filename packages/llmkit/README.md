...
A modular LLM toolkit for educational and research purposes.
...
```bash
uv pip install -e packages/llmkit
```
...
```python
import torch
from llmkit import GPT, ModelConfig, DataLoaderLite, Trainer, generate
...
from llmkit import AttentionConfig, FeedForwardConfig
